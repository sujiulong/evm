...
func (mc *mockCaller) CallContract(ctx context.Context, call evm.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call evm.CallMsg) ([]byte, error) {
